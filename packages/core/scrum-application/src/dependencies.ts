...
import type { SprintProgressLog } from './ports/sprint-progress-log.js'
import type { SprintRepository } from './ports/sprints.js'
import type { TransactionPort } from './ports/transactions.js'
...
export interface ApplicationDependencies {
  ...
  readonly sprintProgressLog: SprintProgressLog
